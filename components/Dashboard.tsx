    ...
    <div className="space-y-12 pb-40 fade-in px-2 max-w-2xl mx-auto">
      ...
      <div className="bg-white border border-[#D1D1C7] rounded-sm shadow-sm overflow-hidden flex flex-col items-center">
        ...
        <div className="p-10 md:p-20 space-y-20 text-center w-full">
          ...
          {/* ✅ 修復壓字問題：增加 py-20 與 px-10 以上內距，文字設為 leading-[1.8] */}
          <div className="bg-[#F5F5F0] py-20 px-10 md:px-20 border-y border-[#D1D1C7]/40 shadow-inner max-w-2xl mx-auto space-y-8 my-16">
             ...
             <p className="text-lg leading-[1.8] text-[#8C7E6D] serif italic mt-10 border-t border-[#D1D1C7]/30 pt-8 tracking-[0.15em]">“{profile.psychology.scene}”</p>
          </div>
              ...
              {Object.entries(profile.pouches).map(([key, value], i) => {
                ...
                return (
                  <div key={key} className="bg-white border-b border-[#D1D1C7]/80 pb-10 space-y-4 shadow-sm">
                    ...
                    <p className="text-xl md:text-2xl font-bold text-[#2D2D2D] serif leading-relaxed px-8">{value}</p>
                  </div>
                );
              })}
            </div>
        ...
        <div className="bg-white border border-[#D1D1C7] rounded-sm shadow-2xl overflow-hidden animate-fade-in flex flex-col items-center mt-20 mb-32">
          ...
          <div className="p-10 md:p-24 space-y-20 text-center w-full">
            <section className="space-y-8">
              ...
              <p className="text-2xl md:text-3xl text-[#2D2D2D] font-bold leading-[1.9] serif italic bg-[#FBFBFA] py-20 px-10 rounded-sm shadow-inner border border-[#8C635B]/10 max-w-3xl mx-auto">「{report.soulPortrait.description}」</p>
            </section>
            ...
            <section className="space-y-10">
              ...
              <div className="space-y-10 max-w-2xl mx-auto">
                {/* ✅ 修正動態報告中的區塊壓字問題 */}
                <div className="bg-[#F5F5F0] py-20 px-10 rounded-sm border-y border-[#A64D4D]/15">
            ...
            <section className="space-y-10">
              ...
              <div className="bg-[#FBFBFA] py-20 px-10 border border-[#D1D1C7]/40 flex flex-col items-center gap-6 rounded-sm max-w-2xl mx-auto shadow-sm">
            ...
            <div className="space-y-16">
               ...
               <div className="grid grid-cols-1 gap-10 max-w-2xl mx-auto">
                  <div className="bg-white border-y border-[#D1D1C7]/60 py-20 px-10 space-y-6 shadow-sm">
